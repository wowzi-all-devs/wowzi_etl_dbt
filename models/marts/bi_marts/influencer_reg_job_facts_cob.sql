...
select 
  ...
  d.username_FACEBOOK facebook_username,
  d.username_INSTAGRAM instagram_username,
  d.username_TIKTOK tiktok_username,
  d.username_TWITTER twitter_username,
  d.username_LINKEDIN linkedinusername,
  d.followers_count_FACEBOOK facebook_followers,
  d.followers_count_INSTAGRAM instagram_followers,
  d.followers_count_TIKTOK tiktok_followers,
  d.followers_count_TWITTER twitter_followers,
  d.followers_count_LINKEDIN linkedin_followers,
...
SELECT 
    ...
    true as job_activity,
    null as location,
    date(p.inf_date_account_created) date_account_created,
    null facebook_username,
    null instagram_username,
    null tiktok_username,
    null twitter_username,
    null linkedinusername,
    null facebook_followers,
    null instagram_followers,
    null tiktok_followers,
    null twitter_followers,
    null linkedin_followers,
...
(select 
    ...
    a.twitter_username,
    a.linkedinusername,
    a.facebook_followers,
    a.instagram_followers,
    a.tiktok_followers,
    a.twitter_followers,
    a.linkedin_followers,
